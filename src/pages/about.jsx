...
<div className="min-h-screen flex items-center justify-around place-content-center bg-gray-100">
      <div className="container m-1 p-5">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Column 1 */}
          <div className="mb-4">
            <h2 className="text-2xl font-bold mb-4 text-blue-600">Contact Information 1</h2>
            <img
          ...
          {/* Column 2 */}
          <div className="mb-4">
            <h2 className="text-2xl font-bold mb-4 text-green-600">Contact Information 2</h2>
            <img
              src="https://placekitten.com/200/200" // Replace with your contact's image URL
              alt="Contact 2"
              className="w-500 h-500 object-cover mb-4 rounded-full"
        ...
        <div className="bg-white bg-opacity-20 p-4 rounded-lg shadow-md backdrop-filter backdrop-blur-lg  hover:bg-sky-700 duration-1000 ">
          <div className="flex flex-col md:flex-row items-center justify-center">
            ...
            <div className="text-center">
              <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-white">John Doe</h2>
              <p className="text-gray-300 text-sm md:text-base lg:text-lg">Web Developer</p>
            </div>
          </div>

          <div className="mt-6 md:mt-8">
            <h3 className="text-lg md:text-xl lg:text-2xl font-semibold text-white">Contact Information</h3>
          ...
          <div className="mt-6 md:mt-8">
            <h3 className="text-lg md:text-xl lg:text-2xl font-semibold text-white">Social Media</h3>
