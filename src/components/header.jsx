...
export default function Footer() {
  return (
    ...
    <div className="container sm:hidden flex-wrap uppercase flex items-center justify-center p-6">
        <a href="#" className=" transition-colors duration-300 transform border-b-2 border-blue-500 mx-1.5 ">
        <Link to='/' className=""> 
            <img
              src={home}
              alt="RS"
        ...
        <a href="#" className="border-b-2 border-transparent hover: transition-colors duration-300 transform hover:border-blue-500 mx-1.5 sm:mx-6">features</a>

        <a href="#" className="border-b-2 border-transparent hover: transition-colors duration-300 transform hover:border-blue-500 mx-1.5 sm:mx-6">pricing</a>

        <a href="#" className="border-b-2 border-transparent hover: transition-colors duration-300 transform hover:border-blue-500 mx-1.5 sm:mx-6">blog</a>

        <a href="#" className="border-b-2 border-transparent hover: transition-colors duration-300 transform hover:border-blue-500 mx-1.5 sm:mx-6">
